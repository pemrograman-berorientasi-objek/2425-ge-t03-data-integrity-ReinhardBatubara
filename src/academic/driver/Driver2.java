...
public class Driver2 {
    ...
    public static void main(String[] _args) {
        ...
        while (scanner.hasNext()) {
            ...
            {
                boolean studentmirip = false;
                boolean coursemirip = false;
                String code = inputSegments[1];
                ...
                else if(!studentmirip){
                invalid = "student";
                System.out.println("invalid" + " " + invalid + "|" + id);}  
                else{
        ...
        /*Collections.sort(students, (a1, a2) -> a1.getName().compareTo(a2.getName()));*/
        for (Student student : students) {
